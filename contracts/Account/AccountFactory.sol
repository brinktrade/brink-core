...
contract AccountFactory {
  ...
  function deployAccount(address owner) external returns (address account) {
    ...
    bytes memory initCode = abi.encodePacked(
      ...
      owner,
      hex'60405152005b366000803760008036600073cbf17a64bf6eb5e0d486f2d3cd906b6627fba9cb5af43d6000803e8080156055573d6000f35b3d6000fdfea164736f6c634300080a000a'
    );
    assembly {
